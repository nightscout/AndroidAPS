...
class ExtendedSetAction(
    ...
    override val label: TextRef = CoreUiStrings.extended_bolus
    ...
    override suspend fun execute(tagName: String): NfcExecutionResult {
        ...
        if (result.success) {
            ...
            return NfcExecutionResult(true, rh.gs(SyncStrings.nfccommands_extended_set, amountString, duration))
        } else {
