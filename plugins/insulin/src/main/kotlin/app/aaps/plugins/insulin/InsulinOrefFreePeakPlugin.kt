...
class InsulinOrefFreePeakPlugin @Inject constructor(
    ...
    override fun getOrCreateInsulin(iCfg: ICfg) = ICfg(rh.gs(app.aaps.core.interfaces.R.string.free_peak_oref), peak, dia)
    override fun getInsulin(insulinLabel: String)= ICfg(rh.gs(app.aaps.core.interfaces.R.string.free_peak_oref), peak, dia)
