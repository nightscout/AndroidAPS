...
class InsulinOrefUltraRapidActingPlugin @Inject constructor(
    ...
    override fun getOrCreateInsulin(iCfg: ICfg) = ICfg(rh.gs(R.string.ultra_fast_acting_insulin_comment), peak, dia)
    override fun getInsulin(insulinLabel: String) = ICfg(rh.gs(R.string.ultra_fast_acting_insulin_comment), peak, dia)
