...
class ActionSettingsExportTest : ActionsTestBase() {
    ...
    fun setup() {
        ...
        sut = ActionSettingsExport(aapsLogger, rh, Provider { pumpEnactResultProvider.get() }, rxBus, notificationManager, context, dateUtil, config, persistenceLayer, importExportPrefs, exportPasswordDataStore, preferences)
    }
