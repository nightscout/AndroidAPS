...
class InstaraStaleCheckWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            val latestPumpId: Long = persistenceLayer
                .getLatestInstaraPumpIdForDevice(devicePrefix)
                ?: run {
            ...
            val missing: Long? = persistenceLayer
                .getFirstMissingInstaraPumpIdInRange(scanStart, scanEnd)
            ...
            val latestTs: Long = persistenceLayer
                .getLatestInstaraTimestampForDevice(devicePrefix)
                ?: run {
