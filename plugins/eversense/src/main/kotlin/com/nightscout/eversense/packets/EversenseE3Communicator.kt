    ...
    companion object {
        ...
        fun fullSync(gatt: EversenseGattCallback, preferences: SharedPreferences, watchers: List<EversenseWatcher>) {
            try {
                ...
                val rateEnabled = gatt.writePacket<GetSettingRateEnabledPacket.Response>(GetSettingRateEnabledPacket())
                ...
                val predictiveEnabled = gatt.writePacket<GetSettingPredictiveAlarmEnabledPacket.Response>(GetSettingPredictiveAlarmEnabledPacket())
