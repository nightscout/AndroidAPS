...
class OverviewMenusImpl @Inject constructor(
    ...
    enum class CharTypeData(
        ...
        TIR(R.string.overview_show_tir, app.aaps.core.ui.R.attr.bgInRange, app.aaps.core.ui.R.attr.menuTextColor, primary = true, secondary = false, shortnameId = R.string.tir_shortname),
