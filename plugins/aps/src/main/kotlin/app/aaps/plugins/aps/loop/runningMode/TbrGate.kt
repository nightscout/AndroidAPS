 ...
 *
 * Complements [RunningModeReconciler]: the reconciler enforces that the pump reaches the claimed
 * state; the gate ensures other sources cannot push the pump into a state that contradicts the
 * mode.
 *
