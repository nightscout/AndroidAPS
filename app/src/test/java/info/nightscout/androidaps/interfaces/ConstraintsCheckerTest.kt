...
class ConstraintsCheckerTest : TestBaseWithProfile() {
    ...
    fun prepare() {
        ...
        insightPlugin = LocalInsightPlugin(injector, aapsLogger, rxBus, resourceHelper, sp, commandQueue, profileFunction, nsUpload, context, uploadQueue, ConfigImpl(), dateUtil, databaseHelper, pumpSync)
