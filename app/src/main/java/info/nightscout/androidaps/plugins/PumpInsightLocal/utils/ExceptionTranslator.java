...
import info.nightscout.androidaps.plugins.PumpInsightLocal.exceptions.SocketCreationFailedException;
import info.nightscout.androidaps.plugins.PumpInsightLocal.exceptions.TimeoutException;
import info.nightscout.androidaps.plugins.PumpInsightLocal.exceptions.app_layer_errors.MaximumNumberOfBolusTypeAlreadyRunningException;
import info.nightscout.androidaps.plugins.PumpInsightLocal.exceptions.app_layer_errors.NoActiveTBRToCanceLException;
import info.nightscout.androidaps.plugins.PumpInsightLocal.exceptions.app_layer_errors.NoActiveTBRToChangeException;
import info.nightscout.androidaps.plugins.PumpInsightLocal.exceptions.app_layer_errors.NoSuchBolusToCancelException;
import info.nightscout.androidaps.plugins.PumpInsightLocal.exceptions.app_layer_errors.PumpAlreadyInThatStateException;
import info.nightscout.androidaps.plugins.PumpInsightLocal.exceptions.app_layer_errors.PumpStoppedException;
import info.nightscout.androidaps.plugins.PumpInsightLocal.exceptions.app_layer_errors.RunModeNotAllowedException;
