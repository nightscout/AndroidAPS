...
class OverviewMenus @Inject constructor(
    ...
    fun setupChartMenu(context: Context, chartButton: ImageButton, overviewData: OverviewData, updateGraph:(from: String) -> Unit) {
        ...
        chartButton.setOnClickListener { v: View ->
            ...
            popup.setOnMenuItemClickListener {
                ...
                storeGraphConfig()
                setupChartMenu(context, chartButton, overviewData, updateGraph)
