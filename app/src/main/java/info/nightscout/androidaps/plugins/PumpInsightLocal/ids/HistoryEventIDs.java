...
import info.nightscout.androidaps.plugins.PumpInsightLocal.app_layer.history.history_events.BasalDeliveryChangedEvent;
...
import info.nightscout.androidaps.plugins.PumpInsightLocal.app_layer.history.history_events.CartridgeInsertedEvent;
import info.nightscout.androidaps.plugins.PumpInsightLocal.app_layer.history.history_events.CartridgeRemovedEvent;
...
import info.nightscout.androidaps.plugins.PumpInsightLocal.app_layer.history.history_events.OccurrenceOfErrorEvent;
import info.nightscout.androidaps.plugins.PumpInsightLocal.app_layer.history.history_events.OccurrenceOfMaintenanceEvent;
import info.nightscout.androidaps.plugins.PumpInsightLocal.app_layer.history.history_events.OccurrenceOfWarningEvent;
import info.nightscout.androidaps.plugins.PumpInsightLocal.app_layer.history.history_events.OperatingModeChangedEvent;
import info.nightscout.androidaps.plugins.PumpInsightLocal.app_layer.history.history_events.PowerDownEvent;
