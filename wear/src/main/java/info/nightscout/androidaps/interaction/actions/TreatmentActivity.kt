...
class TreatmentActivity : ViewSelectorActivity() {
    ...
    private inner class MyGridViewPagerAdapter : GridPagerAdapterNonDeprecated() {
        ...
        val incrementInsulin1 = (sp.getDouble(app.aaps.interfaces.R.string.key_insulin_button_increment_1, 0.5) * 10).roundToInt() / 10.0
        val incrementInsulin2 = (sp.getDouble(app.aaps.interfaces.R.string.key_insulin_button_increment_2, 1.0) * 10).roundToInt() / 10.0
