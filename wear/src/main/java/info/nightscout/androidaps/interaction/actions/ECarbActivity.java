    ...
    private class MyGridViewPagerAdapter extends GridPagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int row, int col) {
            ...
            if(col == 0){
                ...
                setLabelToPlusMinusView(view, getResources().getString(R.string.action_start_min));
                container.addView(view);
                return view;
            } else if(col == 2){
                final View view = getInflatedPlusMinusView(container);
                ...
                setLabelToPlusMinusView(view, getResources().getString(R.string.action_duration_h));
                container.addView(view);
                return view;
            } else {
