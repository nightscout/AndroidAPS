...
class RunningModePickerActivity : MenuListActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // lifecycleScope is Main and dies with the activity.
        rxBus.toFlow(EventData.RunningModeList::class)
            .collectResilient(lifecycleScope, aapsLogger, LTag.WEAR, start = CoroutineStart.UNDISPATCHED) {
                modeList = it
                refreshElements()
                updateSubtitle()
            }
