...
class WizardActivity : ViewSelectorActivity() {
    ...
    private inner class MyGridViewPagerAdapter : GridPagerAdapterNonDeprecated() {
        ...
        private val increment1 = preferences.get(IntKeys.OverviewCarbsButtonIncrement1).toDouble()
        private val increment2 = preferences.get(IntKeys.OverviewCarbsButtonIncrement2).toDouble()
