...
class BigMainInfoInquirePacketTest : TestBaseWithProfile() {
    ...
    private val packetInjector = HasAndroidInjector {
        AndroidInjector {
            if (it is BigMainInfoInquirePacket) {
    ...
    fun encodeShouldGenerateValidPacket() {
        // Given
        val packet = BigMainInfoInquirePacket(packetInjector)
        val msgSeq = 12
        ...
        // Check message type
        assertThat(encoded[1]).isEqualTo(0x73.toByte())
        // Check sequence
    ...
    fun friendlyNameShouldBeCorrect() {
        ...
        // Then
        assertThat(packet.friendlyName).isEqualTo("PUMP_BIG_MAIN_INFO_INQUIRE")
    }
}
