...
class BolusSpeedSettingPacketTest : TestBaseWithProfile() {

    private lateinit var diaconnG8Pump: DiaconnG8Pump

    private val packetInjector = HasAndroidInjector {
        AndroidInjector {
            if (it is BolusSpeedSettingPacket) {
    ...
    fun encodeShouldGenerateValidPacketWithType() {
        // Given - Speed level 5
        val type = 5
        val packet = BolusSpeedSettingPacket(packetInjector, type)
        ...
        assertThat(encoded[1]).isEqualTo(0x05.toByte()) // msgType
    ...
    @Test
    fun encodeShouldHandleMinSpeed() {
    ...
    @Test
    fun encodeShouldHandleMaxSpeed() {
    ...
    fun msgTypeShouldBeCorrect() {
        // Given
        val packet = BolusSpeedSettingPacket(packetInjector, 5)

        // Then
        assertThat(packet.msgType).isEqualTo(0x05.toByte())
    }
    ...
    fun friendlyNameShouldBeCorrect() {
        ...
        // Then
        assertThat(packet.friendlyName).isEqualTo("PUMP_BOLUS_SPEED_SETTING_PACKET")
    }
}
