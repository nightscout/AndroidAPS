...
class LogSuspendV2Test : TestBase() {
    ...
    fun parseValidLogDataWithBasePattern() {
        ...
        assertThat(log.kind).isEqualTo(LogSuspendV2.LOG_KIND)
    ...
    fun toStringContainsAllFields() {
        ...
        // Then
        assertThat(result).contains("LOG_SUSPEND_V2")
        assertThat(result).contains("LOG_KIND=${LogSuspendV2.LOG_KIND.toInt()}")
    ...
    fun logKindConstantIsCorrect() {
        // Then
        assertThat(LogSuspendV2.LOG_KIND).isEqualTo(0x03.toByte())
    }
}
