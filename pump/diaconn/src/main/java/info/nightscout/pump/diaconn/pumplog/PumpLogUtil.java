...
public class PumpLogUtil {
     ...
     * @return GMT 날짜 문자열
     */
    @NonNull @SuppressLint("SimpleDateFormat")
    public static String getDttm(@NonNull String data) {
	...
	*/
     ...
     * @return byte
     */
    public static byte getType(@NonNull String data) {
     ...
     * @return byte
     */
    public static byte getKind(@NonNull String data) {
        byte[] bytes = hexStringToByteArray(data);
