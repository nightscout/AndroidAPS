package app.aaps.pump.equil.ble.operations;
...
public class DescriptorWriteOperation extends BLECommOperation {
    ...
    public DescriptorWriteOperation(AAPSLogger aapsLogger, BluetoothGatt gatt,
                                    BluetoothGattDescriptor descr, byte[] value) {
