...
class CmdRunningModeGetTest : TestBaseWithProfile() {
    ...
    fun `getEventType should return null`() {
        val cmd = CmdRunningModeGet(aapsLogger, preferences, equilManager)
    ...
    fun `getFirstData should have correct command bytes`() {
        ...
        // Bytes at positions 4 and 5 should be 0x02, 0x00
    ...
    @Test
    fun `decodeConfirmData should parse mode and set to equilManager`() {
        val cmd = CmdRunningModeGet(aapsLogger, preferences, equilManager)
        ...
        verify(equilManager).setRunMode(5)
    ...
    @Test
    fun `decodeConfirmData should handle different mode values`() {
        val cmd = CmdRunningModeGet(aapsLogger, preferences, equilManager)
        val testData = ByteArray(10)
        testData[6] = 0xFF.toByte() // Mode = 255
        ...
        verify(equilManager).setRunMode(255)
        assertTrue(cmd.cmdSuccess)
    }
