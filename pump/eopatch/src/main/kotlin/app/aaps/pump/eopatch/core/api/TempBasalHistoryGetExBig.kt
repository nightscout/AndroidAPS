...
@Inject
class TempBasalHistoryGetExBig(patch: IBleDevice, aapsLogger: AAPSLogger) : BaseAPI<BasalHistoryResponse>(PatchFunc.GET_TEMP_BASAL_HISTORY_EX, patch, aapsLogger) {
