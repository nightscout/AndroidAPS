...
internal class CarelevoCancelImmeBolusInfusionUseCaseTest {
    ...
    private val sut = CarelevoCancelImmeBolusInfusionUseCase(
        patchObserver,
        bolusRepository,
        patchInfoRepository,
    ...
    fun execute_returns_success_when_cancel_succeeds() {
        ...
        whenever(bolusRepository.requestCancelImmeBolus()).thenAnswer {
            emitAsync(CancelImmeBolusResultModel(Result.SUCCESS, remains = 80.0, infusedAmount = 0.5))
