...
internal class CarelevoConnectNewPatchUseCaseTest {
    ...
    private val patchEvent = PublishSubject.create<info.nightscout.androidaps.plugins.pump.carelevo.domain.model.bt.PatchResultModel>()
    ...
    private fun emitAsync(
        event: info.nightscout.androidaps.plugins.pump.carelevo.domain.model.bt.PatchResultModel,
        delayMs: Long = 5L
    ) {
        Thread {
