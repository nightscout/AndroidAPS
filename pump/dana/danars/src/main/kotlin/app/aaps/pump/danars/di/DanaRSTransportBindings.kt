 ...
 * because `:pump:dana:danars:emulator` sits on `:pump:dana:common` rather than on the driver, so the
 * driver is free to depend on the emulator without a cycle. The app now names no Dana RS type at all.
 */
