...
class DanaRS_Packet_General_Initial_Screen_Information(
    ...
    override fun handleMessage(data: ByteArray) {
        ...
        if (data.size >= 18) {
            ...
            dataIndex += dataSize
            dataSize = 1
            danaRPump.errorState = info.nightscout.androidaps.dana.DanaRPump.ErrorState[byteArrayToInt(getBytes(data, dataIndex, dataSize))]
                ?: info.nightscout.androidaps.dana.DanaRPump.ErrorState.NONE
