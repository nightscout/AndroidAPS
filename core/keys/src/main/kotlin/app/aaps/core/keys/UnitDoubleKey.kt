...
enum class UnitDoubleKey(
    ...
    OverviewVeryHighMark(key = "very_high_mark", defaultValue = 380.0, minMgdl =180, maxMgdl =380, titleResId = R.string.pref_title_very_high_mark, showInNsClientMode = false),
    ApsLgsThreshold(
        key = "lgsThreshold",
        defaultValue = 65.0,
        minMgdl = 60,
