...
//       assertThat(p.timeZone).isEqualTo(TimeZone.getTimeZone("UTC"))
        ...
        assertThat(p.getIsfMgdl(c.timeInMillis, "test")).isWithin(0.01).of(108.0)
        c[Calendar.HOUR_OF_DAY] = 2
        assertThat(p.getIsfMgdl(c.timeInMillis, "test")).isWithin(0.01).of(111.6)
...
//        assertThat( p.getTargetHighTimeFromMidnight(2 * 60 * 60)).isWithin(0.01).of(5.0)
        ...
        assertThat(p.getIsfMgdl(c.timeInMillis, "test")).isWithin(0.01).of(223.2)
