...
class ProfileSealedTest : TestBase() {
    ...
    fun prepare() {
        ...
        whenever(rh.gs(TextRef.AndroidRes(app.aaps.core.interfaces.R.string.profile_isf_units_mgdl))).thenReturn("mg/dL/U")
        whenever(rh.gs(TextRef.AndroidRes(app.aaps.core.interfaces.R.string.profile_isf_units_mmol))).thenReturn("mmol/L/U")
        whenever(rh.gs(TextRef.AndroidRes(app.aaps.core.interfaces.R.string.profile_carbs_per_unit))).thenReturn("g/U")
        whenever(rh.gs(TextRef.AndroidRes(app.aaps.core.interfaces.R.string.profile_ins_units_per_hour))).thenReturn("U/h")
