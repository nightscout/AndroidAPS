 ...
 *
 * Unlike `dagger.android`, a missing binding **fails loudly**. Silently skipping would leave `lateinit`
 * fields unset, and that surfaces later as an unrelated crash somewhere else.
 */
