...
fun ElementType.color(): Color = when (this) {
    ...
    ElementType.QUICK_WIZARD_MANAGEMENT_PLAY,
    ElementType.QUICK_WIZARD_MANAGEMENT_EDIT -> AapsTheme.elementColors.quickWizard
    ...
    ElementType.INSULIN_MANAGEMENT_PLAY,
    ElementType.INSULIN_MANAGEMENT_EDIT      -> AapsTheme.elementColors.insulin

    ElementType.PROFILE_MANAGEMENT_PLAY,
    ElementType.PROFILE_MANAGEMENT_EDIT      -> AapsTheme.elementColors.profileSwitch

    ElementType.TEMP_TARGET_MANAGEMENT_PLAY,
    ElementType.TEMP_TARGET_MANAGEMENT_EDIT  -> AapsTheme.elementColors.tempTarget
...
fun ElementType.icon(): ImageVector = when (this) {
    ...
    ElementType.QUICK_WIZARD,
    ElementType.QUICK_WIZARD_MANAGEMENT_PLAY,
    ElementType.QUICK_WIZARD_MANAGEMENT_EDIT -> IcQuickwizard
    ...
    ElementType.INSULIN_MANAGEMENT_PLAY,
    ElementType.INSULIN_MANAGEMENT_EDIT      -> IcPluginInsulin

    ElementType.PROFILE_MANAGEMENT_PLAY,
    ElementType.PROFILE_MANAGEMENT_EDIT      -> IcProfile

    ElementType.TEMP_TARGET_MANAGEMENT_PLAY,
    ElementType.TEMP_TARGET_MANAGEMENT_EDIT  -> IcTtHigh
...
fun ElementType.labelResId(): Int = when (this) {
    ...
    ElementType.QUICK_WIZARD_MANAGEMENT_PLAY -> R.string.quickwizard_managemnt
    ElementType.QUICK_WIZARD_MANAGEMENT_EDIT -> R.string.quickwizard_managemnt
    ...
    ElementType.INSULIN_MANAGEMENT_PLAY      -> R.string.insulin_management
    ElementType.INSULIN_MANAGEMENT_EDIT      -> R.string.insulin_management
    ElementType.PROFILE_MANAGEMENT_PLAY      -> R.string.careportal_profileswitch
    ElementType.PROFILE_MANAGEMENT_EDIT      -> R.string.profile_management
    ElementType.TEMP_TARGET_MANAGEMENT_PLAY  -> R.string.temporary_target
    ElementType.TEMP_TARGET_MANAGEMENT_EDIT  -> R.string.temp_target_management
...
fun ElementType.descriptionResId(): Int = when (this) {
    ...
    ElementType.INSULIN_MANAGEMENT_PLAY,
    ElementType.INSULIN_MANAGEMENT_EDIT      -> R.string.manage_insulin_desc

    ElementType.PROFILE_MANAGEMENT_PLAY,
    ElementType.PROFILE_MANAGEMENT_EDIT      -> R.string.manage_profile_desc

    ElementType.TEMP_TARGET_MANAGEMENT_PLAY,
    ElementType.TEMP_TARGET_MANAGEMENT_EDIT  -> R.string.manage_temp_target_desc

    ElementType.QUICK_WIZARD_MANAGEMENT_PLAY,
    ElementType.QUICK_WIZARD_MANAGEMENT_EDIT -> R.string.manage_quickwizard_desc
