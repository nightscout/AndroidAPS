 ...
 * negative-token form of [TextRef.AndroidRes]. The ~18 call sites do not change again.
 *
 * On Android today [TextRef.AndroidRes.id] is always an ordinary `R.string` id, so this is a direct call
