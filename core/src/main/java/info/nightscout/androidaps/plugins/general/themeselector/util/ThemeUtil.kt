...
object ThemeUtil {
    ...
    @JvmStatic  fun getThemeName(theme: Int, mIsNightMode: Boolean): String {
        ...
        when (theme) {
            ...
            THEME_BLUE       -> themeName = if ( mIsNightMode) "Blue" else "Blue"
            THEME_LIGHTBLUE  -> themeName = if ( mIsNightMode) "Lightblue" else "Lightblue"
            THEME_CYAN       -> themeName = if ( mIsNightMode) "Cyan" else "Cyan"
            ...
            THEME_LIME       -> themeName = if ( mIsNightMode) "lime" else "Lime"
            THEME_YELLOW     -> themeName = if ( mIsNightMode) "Yellow" else "Yellow"
