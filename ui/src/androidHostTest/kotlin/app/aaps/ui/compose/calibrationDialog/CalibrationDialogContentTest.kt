...
/** Robolectric composable test for [CalibrationDialogContent]: renders + fires navigate-back (Close). */
@RunWith(RobolectricTestRunner::class)
@GraphicsMode(GraphicsMode.Mode.NATIVE)
@Config(sdk = [35])
class CalibrationDialogContentTest {
        ...
        compose.setContent {
            MaterialTheme {
                CalibrationDialogContent(
                    ...
                    showMarkSensorChange = false,
                    canMarkSensorChange = false,
                    onMarkSensorChange = {},
                    onBgChange = {},
